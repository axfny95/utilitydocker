      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="mt-4 flex gap-2">
            <button onClick={downloadPNG} disabled={!qrLib} className="rounded-lg bg-primary-600 px-4 py-2 text-sm font-medium text-white hover:bg-primary-700 disabled:opacity-50 disabled:cursor-not-allowed">
              Download PNG
            </button>
            {qrLib && (
