...
const STYLES: { name: string; map: Record<string, string> | ((c: string) => string) }[] = [
  ...
  { name: 'Script', map: (c) => { const n = c.charCodeAt(0); if (n >= 65 && n <= 90) return String.fromCodePoint(0x1D49C + n - 65); if (n >= 97 && n <= 122) return String.fromCodePoint(0x1D4B6 + n - 97); return c; } },
