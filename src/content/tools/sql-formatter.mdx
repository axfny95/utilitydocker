---
title: "SQL Formatter"
description: "Format and beautify messy SQL queries instantly. Supports standard SQL syntax. Free, private, browser-based."
...
faq:
  - question: "Which SQL dialects does the formatter support?"
    answer: "The tool supports standard SQL along with dialect-specific syntax for MySQL, PostgreSQL, Microsoft SQL Server, and SQLite. The formatter recognizes standard SQL keywords and structures them with proper indentation."
